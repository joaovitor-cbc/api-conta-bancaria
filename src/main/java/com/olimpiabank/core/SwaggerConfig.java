...
public class SwaggerConfig {
	...
	public Docket getDocket() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.apicontabancaria.domain.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Simple Spring Boot REST API").description("Aplicação simples com springboot")
				.version("1.0.0").license("Apache License Version 2.0").build();
	}
}
